...
# docs/_theme/, offline/ and print/ beside it — so the documentation
# builds without a sibling checkout (CI). build.sh mirrors _theme/ into
# the language projects. Run this after changing the theme, then
# rebuild and commit.
set -e
cd "$(dirname "$0")"
